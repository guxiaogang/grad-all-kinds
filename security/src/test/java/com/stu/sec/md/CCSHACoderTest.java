...
public class CCSHACoderTest {
	...
	public final void testEncodeSHA() throws Exception {
		...
		// 获得摘要信息
		byte[] data1 = CCSHACoder.encodeSHA(str);
		byte[] data2 = CCSHACoder.encodeSHA(str);
	...
	public final void testEncodeSHAHex() throws Exception {
		...
		// 获得摘要信息
		String data1 = CCSHACoder.encodeSHAHex(str);
		String data2 = CCSHACoder.encodeSHAHex(str);
	...
	public final void testEncodeSHA256() throws Exception {
		...
		// 获得摘要信息
		byte[] data1 = CCSHACoder.encodeSHA256(str);
		byte[] data2 = CCSHACoder.encodeSHA256(str);
	...
	public final void testEncodeSHA256Hex() throws Exception {
		...
		// 获得摘要信息
		String data1 = CCSHACoder.encodeSHA256Hex(str);
		String data2 = CCSHACoder.encodeSHA256Hex(str);
	...
	public final void testEncodeSHA384() throws Exception {
		...
		// 获得摘要信息
		byte[] data1 = CCSHACoder.encodeSHA384(str);
		byte[] data2 = CCSHACoder.encodeSHA384(str);
	...
	public final void testEncodeSHA384Hex() throws Exception {
		...
		// 获得摘要信息
		String data1 = CCSHACoder.encodeSHA384Hex(str);
		String data2 = CCSHACoder.encodeSHA384Hex(str);
	...
	public final void testEncodeSHA512() throws Exception {
		...
		// 获得摘要信息
		byte[] data1 = CCSHACoder.encodeSHA512(str);
		byte[] data2 = CCSHACoder.encodeSHA512(str);
	...
	public final void testEncodeSHA512Hex() throws Exception {
		...
		// 获得摘要信息
		String data1 = CCSHACoder.encodeSHA512Hex(str);
		String data2 = CCSHACoder.encodeSHA512Hex(str);
